...
#define TK_FS_OBLIQUE                                                          \
    2 /* This value is only used when parsing X                                \
...
#define TK_FS_UNKNOWN                                                          \
    -1 /* Unknown slant.  This value is used for                               \
        * error checking and is never actually stored                          \
        * in the slant field. */
...
#define TK_SW_UNKNOWN                                                          \
    3 /* Unknown setwidth.  This value may be                                  \
...
EXTERN int TkCreateNamedFont
_ANSI_ARGS_((Tcl_Interp *interp, Tk_Window tkwin, CONST char *name,
             TkFontAttributes *faPtr));
EXTERN void TkInitFontAttributes _ANSI_ARGS_((TkFontAttributes *faPtr));
EXTERN int TkParseXLFD
_ANSI_ARGS_((CONST char *string, TkXLFDAttributes *xaPtr));
