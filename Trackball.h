...
class Trackball {
  ...
  public:
    ...
    void setup(float c[3], float o[3], float up[3], float r, float fov = 45.0,
    ...
    void getState(Pnt3 &c, Pnt3 &o, Pnt3 &t, float q[4], float &fov,
                  float &oblique_x, float &oblique_y);
    ...
    void getProjection(float &pFov, float &pAsp_rat, float &zNear, float &pFar);
