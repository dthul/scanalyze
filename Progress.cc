...
bool Progress::update(int current) {
    ...
    glBegin(GL_QUADS);
    glColor3f(.7, 0, 0);
    rect(0, baseY, theWidth - 1, baseY + 19);
    glColor3f(.2, 0, 0);
    rect(1, baseY + 1, theWidth, baseY + 20);
    glEnd();
...
bool Progress::updateInc(int increment) { return update(value + increment); }
