...
class CameraParams {
  ...
  public:
    ...
    CameraParams(int _imgwidth, int _imgheight, double _Tx, double _Ty,
                 double _Tz, double _Rx, double _Ry, double _Rz, double _Cx,
                 double _Cy, double _Scale, double _pixels_per_radian)
        : imgwidth(_imgwidth), imgheight(_imgheight), Tx(_Tx), Ty(_Ty), Tz(_Tz),
          Rx(_Rx), Ry(_Ry), Rz(_Rz), Cx(_Cx), Cy(_Cy), S(_Scale),
