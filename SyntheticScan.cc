...
MeshTransport *SyntheticScan::mesh(bool perVertex, bool stripped,
...
OccSt SyntheticScan::carve_cube(const Pnt3 &ctr, float side) {
    side /= 2;
...
float SyntheticScan::closest_along_line_of_sight(const Pnt3 &p, Pnt3 &cp,
                                                 OccSt &status_p) {
#if SYNTH_CUBE
