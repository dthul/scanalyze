...
void getVertexNormals(const vector<Pnt3> &vtx, const vector<int> &tri,
                      bool strips, vector<short> &nrm, int useArea = 0);
...
float median_edge_length(vector<Pnt3> &vtx, vector<int> &tri,
                         bool strips = false, int percentile = 50);
...
void remove_stepedges(vector<Pnt3> &vtx, vector<int> &tri, int factor,
                      int percentile = 50, bool strips = false);
...
void tris_to_strips(int numvertices, const vector<int> &tris,
                    vector<int> &tstripinds, const char *name = NULL);

void strips_to_tris(const vector<int> &tstripinds, vector<int> &tris,
                    int nTris = 0);

void flip_tris(vector<int> &inds, bool stripped = 0);
