...
class RigidScan : public ResolutionCtrl, public TbObj {
  ...
  closest_point(const Pnt3 &p, Pnt3 &cl_pnt, Pnt3 &cl_nrm);
    ...
    virtual float closest_point_on_mesh(const Pnt3 &p, Pnt3 &cl_pnt,
                                        OccSt &status_p);
    virtual float closest_along_line_of_sight(const Pnt3 &p, Pnt3 &cp,
                                              OccSt &status_p);

    virtual float closest_along_line(const Pnt3 &p, const Pnt3 &dir, Pnt3 &cp,
                                     OccSt &status_p);

    virtual float color_along_line_of_sight(const Pnt3 &p, float rgb[3]);
    virtual float color_along_line_of_sight(const Pnt3 &p, uchar rgb[3]);
