...
typedef enum { cfPOINT, cfBOX, cfMEDIAN, cfMEAN50 } CyraFilter;
...
class CyraResLevel {
  ...
  public:
    ...
    virtual MeshTransport *mesh(bool perVertex, bool stripped,
  ...
  private:
    ...
    bool colorMesh(vector<uchar> &colors, bool perVertex, ColorSource source,
                   int colorSize);
