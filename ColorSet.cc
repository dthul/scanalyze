...
ColorSet::ColorSet(void) { currentColor = 0; }

static float colorSet[][3] = { { 0.9 * 0.75, 0.15 * 0.75, 0.35 * 0.75 },
...
void ColorSet::chooseNewColor(uchar *color) {
...
void pushColor(vector<uchar> &colors, int colorsize, uchar *values1,
    ...
    pushColor(colors, colorsize, (values1[0] + values2[0] + values3[0]) / 3,
