...
typedef enum { alignHorn, alignChenMedioni } AlignmentMethod;
...
void horn_align(Pnt3 *src,    // source points to align
...
void chen_medioni(Pnt3 *src,    // source points to align
