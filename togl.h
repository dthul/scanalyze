...
extern int Togl_Configure(Tcl_Interp *interp, struct Togl *togl, int argc,
                          char *argv[], int flags);
...
extern unsigned long Togl_AllocColor(const struct Togl *togl, float red,
...
extern unsigned long Togl_AllocColorOverlay(const struct Togl *togl, float red,
                                            float green, float blue);

extern void Togl_FreeColorOverlay(const struct Togl *togl, unsigned long index);
...
extern void Togl_StereoFrustum(GLfloat left, GLfloat right, GLfloat bottom,
...
extern int Togl_DumpToEpsFile(const struct Togl *togl, const char *filename,
                              int inColor,
