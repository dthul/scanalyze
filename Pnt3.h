...
class Pnt3 {
  ...
  public:
    ...
    friend float dist2_tri(const Pnt3 &, const Pnt3 &, const Pnt3 &,
                           const Pnt3 &);

    friend bool closer_on_lineseg(const Pnt3 &, Pnt3 &, const Pnt3 &,
                                  const Pnt3 &, float &);
    friend bool closer_on_tri(const Pnt3 &, Pnt3 &, const Pnt3 &, const Pnt3 &,
                              const Pnt3 &, float &);

    friend float dot(const Pnt3 &a, const Pnt3 &b);
    friend Pnt3 cross(const Pnt3 &a, const Pnt3 &b);
    friend Pnt3 cross(const Pnt3 &a, const Pnt3 &b, const Pnt3 &c);
    friend Pnt3 normal(const Pnt3 &, const Pnt3 &, const Pnt3 &);
    friend float det(const Pnt3 &, const Pnt3 &, const Pnt3 &);
    friend void line_plane_X(const Pnt3 &p, const Pnt3 &dir, const Pnt3 &t1,
                             const Pnt3 &t2, const Pnt3 &t3, Pnt3 &x,
                             float &dist);
    friend void line_plane_X(const Pnt3 &p, const Pnt3 &dir, const Pnt3 &nrm,
                             float d, Pnt3 &x, float &dist);

    friend void bary(const Pnt3 &p, const Pnt3 &t1, const Pnt3 &t2,
                     const Pnt3 &t3, float &b1, float &b2, float &b3);
    friend void bary_fast(const Pnt3 &p, const Pnt3 &n, const Pnt3 &t0,
                          const Pnt3 &v1, const Pnt3 &v2, float &b1, float &b2,
                          float &b3);
    friend void bary(const Pnt3 &p, const Pnt3 &dir, const Pnt3 &t1,
                     const Pnt3 &t2, const Pnt3 &t3, float &b1, float &b2,
                     float &b3);
    friend int above_plane(const Pnt3 &p, const Pnt3 &a, const Pnt3 &b,
                           const Pnt3 &c);

    float smallest_circle(const Pnt3 &, const Pnt3 &, const Pnt3 &);

    // functions used for closest point searching in KDtrees and octrees
    friend bool ball_within_bounds(const Pnt3 &, float, const Pnt3 &, float);
    friend bool ball_within_bounds(const Pnt3 &, float, const Pnt3 &,
                                   const Pnt3 &);
    friend bool bounds_overlap_ball(const Pnt3 &, float, const Pnt3 &, float);
    friend bool bounds_overlap_ball(const Pnt3 &, float, const Pnt3 &,
                                    const Pnt3 &);
    friend bool spheres_intersect(const Pnt3 &, const Pnt3 &, float, float);
    friend bool lines_intersect(const Pnt3 &p1, const Pnt3 &p2, const Pnt3 &p3,
                                const Pnt3 &p4, Pnt3 &isect);
...
inline Pnt3 &Pnt3::operator+=(const Pnt3 &a) {
    v[0] += a.v[0];
    v[1] += a.v[1];
    v[2] += a.v[2];
    return *this;
...
inline Pnt3 &Pnt3::operator*=(const float &a) {
    v[0] *= a;
    v[1] *= a;
    v[2] *= a;
    return *this;
...
inline int Pnt3::operator==(const Pnt3 &a) {
...
inline Pnt3 operator+(const Pnt3 &a, const Pnt3 &b) {
    Pnt3 tmp = a;
    return (tmp += b);
}
...
inline Pnt3 operator*(const Pnt3 &a, const float &b) {
    Pnt3 tmp = a;
    return (tmp *= b);
}

inline Pnt3 operator*(const float &a, const Pnt3 &b) {
    Pnt3 tmp = b;
    return (tmp *= a);
}
...
inline ostream &operator<<(ostream &out, const Pnt3 &a) {
    return out << "[" << a.v[0] << " " << a.v[1] << " " << a.v[2] << "]";
}

inline istream &operator>>(istream &in, Pnt3 &a) {
    char c = 0;
    in >> ws >> c;
    if (c == '[') {
...
inline float Pnt3::norm() const {
    return sqrtf(v[0] * v[0] + v[1] * v[1] + v[2] * v[2]);
}

inline float Pnt3::norm2() const {
    return v[0] * v[0] + v[1] * v[1] + v[2] * v[2];
}

inline Pnt3 &Pnt3::normalize(void) {
...
inline Pnt3 &Pnt3::set_norm(float len) {
    float a = v[0] * v[0] + v[1] * v[1] + v[2] * v[2];
    if (a != 0) {
        a = len / sqrtf(a);
        v[0] *= a;
...
inline float dist2(const Pnt3 &a, const Pnt3 &b) {
    float x = a.v[0] - b.v[0];
    float y = a.v[1] - b.v[1];
    float z = a.v[2] - b.v[2];
    return x * x + y * y + z * z;
...
inline float dist(const Pnt3 &a, const Pnt3 &b) { return sqrtf(dist2(a, b)); }

inline float dist2_2d(const Pnt3 &a, const Pnt3 &b) {
    float x = a.v[0] - b.v[0];
    float y = a.v[1] - b.v[1];
    return x * x + y * y;
}

inline float dist_2d(const Pnt3 &a, const Pnt3 &b) {
    return sqrtf(dist2_2d(a, b));
}

inline float dist_manhattan(const Pnt3 &a, const Pnt3 &b) {
...
inline float dist2_lineseg(const Pnt3 &x, const Pnt3 &a, const Pnt3 &b) {
    Pnt3 ba = b;
    ba -= a;
    Pnt3 xa = x;
    xa -= a;
...
inline float dist2_tri(const Pnt3 &x, const Pnt3 &t1, const Pnt3 &t2,
                       const Pnt3 &t3) {
    ...
    float tmp = (x.v[0] - t1.v[0]) * n.v[0] + (x.v[1] - t1.v[1]) * n.v[1] +
                (x.v[2] - t1.v[2]) * n.v[2];
    ...
    if (b1 < 0.0) {
        if (b2 < 0.0) {
            ...
            return dist2_lineseg(x, t2, t3);
    } else if (b2 < 0.0) {
        if (b3 < 0.0) {
            return dist2(x, t1);
        } else
            return dist2_lineseg(x, t1, t3);
    } else
        return dist2_lineseg(x, t1, t2);
}

inline bool closer_on_lineseg(const Pnt3 &x, Pnt3 &cp, const Pnt3 &a,
...
inline bool closer_on_tri(const Pnt3 &x, Pnt3 &cp, const Pnt3 &t1,
    ...
    if (b1 < 0.0) {
        if (b2 < 0.0) {
            ...
            return closer_on_lineseg(x, cp, t2, t3, d2);
    } else if (b2 < 0.0) {
        if (b3 < 0.0) {
            float nd = dist2(x, t1);
            if (nd < d2) {
            ...
            return closer_on_lineseg(x, cp, t1, t3, d2);
    } else
        return closer_on_lineseg(x, cp, t1, t2, d2);
}

inline float dot(const Pnt3 &a, const Pnt3 &b) {
    return (a.v[0] * b.v[0] + a.v[1] * b.v[1] + a.v[2] * b.v[2]);
}

inline Pnt3 cross(const Pnt3 &a, const Pnt3 &b) {
...
inline Pnt3 cross(const Pnt3 &a, const Pnt3 &b, const Pnt3 &c) {
...
inline Pnt3 normal(const Pnt3 &a, const Pnt3 &b, const Pnt3 &c) {
    float a0 = a.v[0] - c.v[0];
    float a1 = a.v[1] - c.v[1];
    float a2 = a.v[2] - c.v[2];
    float b0 = b.v[0] - c.v[0];
...
inline float det(const Pnt3 &a, const Pnt3 &b, const Pnt3 &c) {
...
inline void line_plane_X(const Pnt3 &p, const Pnt3 &dir, const Pnt3 &t1,
                         const Pnt3 &t2, const Pnt3 &t3, Pnt3 &x, float &dist) {
...
inline void line_plane_X(const Pnt3 &p, const Pnt3 &dir, const Pnt3 &nrm,
                         float d, Pnt3 &x, float &dist) {
    float tmp = dot(nrm, dir);
    if (tmp == 0.0) {
        cerr << "Cannot intersect plane with a parallel line" << endl;
...
inline void bary(const Pnt3 &p, const Pnt3 &t1, const Pnt3 &t2, const Pnt3 &t3,
...
inline void bary_fast(const Pnt3 &p, const Pnt3 &n, const Pnt3 &t0,
                      const Pnt3 &v1, const Pnt3 &v2, float &b1, float &b2,
                      float &b3) {
    // see bary above
    int i = 0;
...
inline void bary(const Pnt3 &p, const Pnt3 &dir, const Pnt3 &t1, const Pnt3 &t2,
                 const Pnt3 &t3, float &b1, float &b2, float &b3) {
    Pnt3 x;
    float d;
...
inline int above_plane(const Pnt3 &p, const Pnt3 &a, const Pnt3 &b,
                       const Pnt3 &c) {
...
inline float Pnt3::smallest_circle(const Pnt3 &A, const Pnt3 &B,
                                   const Pnt3 &C) {
    Pnt3 a(B);
    a -= A;
    Pnt3 b(C);
...
inline bool ball_within_bounds(const Pnt3 &b, float r, const Pnt3 &bc,
                               float br) {
    r -= br;
    if ((b.v[0] - bc.v[0] <= r) || (bc.v[0] - b.v[0] <= r) ||
        (b.v[1] - bc.v[1] <= r) || (bc.v[1] - b.v[1] <= r) ||
        (b.v[2] - bc.v[2] <= r) || (bc.v[2] - b.v[2] <= r))
        return false;
    return true;
}
...
inline bool ball_within_bounds(const Pnt3 &b, float r, const Pnt3 &min,
                               const Pnt3 &max) {
    if ((b.v[0] - min.v[0] <= r) || (max.v[0] - b.v[0] <= r) ||
        (b.v[1] - min.v[1] <= r) || (max.v[1] - b.v[1] <= r) ||
        (b.v[2] - min.v[2] <= r) || (max.v[2] - b.v[2] <= r))
        return false;
    return true;
}
...
inline bool bounds_overlap_ball(const Pnt3 &b, float r, const Pnt3 &bc,
                                float br) {
    float sum = 0.0, tmp;
...
inline bool bounds_overlap_ball(const Pnt3 &b, float r, const Pnt3 &min,
                                const Pnt3 &max) {
    float sum = 0.0, tmp;
    if (b.v[0] < min.v[0]) {
        tmp = min.v[0] - b.v[0];
...
// squared radius
inline bool spheres_intersect(const Pnt3 &c1, const Pnt3 &c2, float r1sqr,
                              float r2) {
...
// GGems II, p. 142
inline bool lines_intersect(const Pnt3 &p1, const Pnt3 &p2, const Pnt3 &p3,
                            const Pnt3 &p4, Pnt3 &isect) {
    Pnt3 a = p2 - p1;
    Pnt3 b = p4 - p3;
    Pnt3 axb = cross(a, b);
...
inline Pnt3 &Pnt3::xform(float m[16]) {
...
inline Pnt3 &Pnt3::xform(double m[16]) {
    float x = m[0] * v[0] + m[4] * v[1] + m[8] * v[2] + m[12];
    float y = m[1] * v[0] + m[5] * v[1] + m[9] * v[2] + m[13];
    v[2] = m[2] * v[0] + m[6] * v[1] + m[10] * v[2] + m[14];
    v[0] = x;
...
inline Pnt3 &Pnt3::xform(float r[3][3], float t[3]) {
...
inline Pnt3 &Pnt3::xform(float r[3][3], double t[3]) {
    float x = t[0] + r[0][0] * v[0] + r[0][1] * v[1] + r[0][2] * v[2];
    float y = t[1] + r[1][0] * v[0] + r[1][1] * v[1] + r[1][2] * v[2];
    v[2] = t[2] + r[2][0] * v[0] + r[2][1] * v[1] + r[2][2] * v[2];
    v[0] = x;
...
inline Pnt3 &Pnt3::invxform(float m[16]) {
    float tx = v[0] - m[12];
    float ty = v[1] - m[13];
    float tz = v[2] - m[14];
...
inline Pnt3 &Pnt3::invxform(double m[16]) {
    double tx = v[0] - m[12];
    double ty = v[1] - m[13];
    double tz = v[2] - m[14];
    v[0] = m[0] * tx + m[1] * ty + m[2] * tz;
...
inline Pnt3 &Pnt3::invxform(float r[3][3], float t[3]) {
    float tx = v[0] - t[0];
    float ty = v[1] - t[1];
    float tz = v[2] - t[2];
...
inline Pnt3 &Pnt3::invxform(float r[3][3], double t[3]) {
    float tx = v[0] - t[0];
    float ty = v[1] - t[1];
    float tz = v[2] - t[2];
    v[0] = r[0][0] * tx + r[1][0] * ty + r[2][0] * tz;
...
inline Pnt3 &Pnt3::setXformed(const Pnt3 &p, float r[3][3], float t[3]) {
...
inline Pnt3 &Pnt3::setRotated(const Pnt3 &p, float r[3][3]) {
...
inline Vec3 &Vec3::xform(float m[16]) {
...
inline Vec3 &Vec3::xform(float r[3][3]) {
