...
bool CyraResLevel::Subsample(CyraResLevel &original, int m, int n,
                             CyraFilter filter) {
...
// by Subsample.
bool CyraResLevel::PointFilter(CyraResLevel &original, int m, int n) {
    CyraSample samp;
...
bool CyraResLevel::Mean50Filter(CyraResLevel &original, int m, int n) {
    CyraSample samp;
    ...
    for (int xx = 0; xx < width; xx++) {
        for (int yy = 0; yy < height; yy++) {
            ...
            for (ox = origxx; ox < origxend; ox++) {
                for (oy = origyy; oy < origyend && nvalid < MAX_VALID_SAMPS;
                     oy++) {
            ...
            case 2:
                ...
                break;
            case 3: { // open scope for local vars...
            ...
            break;
            case -2: { // open scope for local vars...
            ...
            break;
            default: { // open scope for local vars...
                // more than 3 samples....
